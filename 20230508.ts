/* Create a react rating component. */
...
function App() {
  ...
  return (
    <>
      <div className="flex w-full h-screen bg-gray-950 justify-center items-center">
        <div className="bg-gray-900 h-96 w-96 p-8 rounded-3xl ">
          {isSubmitted ? (
...
export const Submitted = ({ rating }: { rating: number }) => {
  return (
    <div className="flex flex-col items-center justify-between h-80 ">
      ...
      <div className="bg-gray-700 text-amber-600 rounded-2xl py-1 px-3">
...
export const Rating = ({
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex">
        <div className="rounded-full bg-gray-700 w-8 h-8 flex justify-center items-center mb-5">
      ...
      <h1 className="mt-3 text-white text-2xl font-normal">How did we do?</h1>
      <div className="mt-3 text-gray-400 font-medium text-sm">
        Please let us know how we did with your support request. All feedback is
        appreciated to help us improve our offering!
      </div>
      <div className="mt-10 flex justify-between">
        {[1, 2, 3, 4, 5].map((btnRating) => (
          <Fragment key={btnRating}>
            <button
              type="button"
              className="rounded-full bg-gray-700 w-10 h-10 text-gray-400 hover:bg-amber-600 hover:text-white focus:bg-gray-400 focus:text-gray-100 hover:border-white hover:border-2"
              onClick={() => setRating(btnRating)}
            >
              {btnRating}
            </button>
          </Fragment>
      ...
      <button
        className="w-full bg-amber-600 p-1 mt-10 rounded-3xl text-white uppercase hover:bg-white hover:text-amber-600 "
        disabled={rating < 1}
      >
        Submit
      </button>
